module.exports = {
  ...
  notFound: {
    english: "Review not found",
    amharic: "አስተያየት አልተገኘም",
    oromifa: "Keeddeebbin hin argamne",
  },

  updateStatus: {
    english: "Status updated successfully ",
    amharic: "ግምገማው በተሳካ ሁኔታ ዘምኗል",
    oromifa: "Haali milkaa’inan jijjiirameera",
  },
  delete: {
    english: "Review deleted successfully",
    amharic: "ግምገማው በተሳካ ሁኔታ ተሰርዟል።",
    oromifa: "Keeddeebiin milkaa’inaan raawwateera",
  },
};
