module.exports = {
  validate: {
    ...
    invalid_priority_type: {
      english: "Priority must be one of [low, medium, high]",
      amharic: "የቅድሚያ አሰጣጥ ደረጃ ከዝቅተኛ ፣ ከመካከለኛ ወይንም ከከፍተኛ አንዱ ብቻ መሆን አለበት",
      oromifa:
        "Dursaa kennuun kanneen keessaa [Ol-aanaa, Gidduu galeessa, Ol-aanaa]",
    },
  },
  get: {
  ...
  update: {
    english: "Data validated successfully",
    amharic: "መረጃው በተሳካ ሁኔታ ተረጋግጧል",
    oromifa: "Daataan haala gariin milkaa’era",
  },
