...
import { getReportingList } from '../../apis/reporting/report';
...
export default function BusDetails() {
  ...
  console.log('reporting data', reportList);
  ...
  return (
    <Paper className={classes.paperContainer}>
      ...
      <div ref={componentRef}>
        <ReportTable data={reportList} loading={isReportListLoading} pageHandler={pageNoHandler} />
      </div>
